...
```{r eval=TRUE, message=FALSE, results=}
...
confirmatory %>% fit
```
```{r, echo = FALSE, eval=TRUE, message=FALSE, results=}
...
Or: Agreed. 
T: Which one do you want to use?
<br>
...
T: That is a good Idea, but maybe KI knows the solution.
