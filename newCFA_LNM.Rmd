...
# We choose n2 from here on, alt### Only PCL has three clusters (when EGA load is set to 0.7 )
...
```{r}
session_info()
```hough looks like all are very similar - do you suggest different network to go with? TOBIAS: I think it doesn't matter
```
