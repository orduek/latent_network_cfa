...
# Run model
lnmMod_5_factor <- lnm(train, lambda = Lambda_5_factor, latents = Latents_5_factor, identification = "variance" )
...
latents_ega = c("Reexp", "mood","Arousal")
lnmMod_EGA <- lnm(train, lambda = ega_factors, 
...
matrixConfirm<-lnmMod_EGA@modelmatrices[[1]]$omega_zeta
LambdaLNM <- lnmMod_EGA@modelmatrices[[1]]$lambda
confirmatoryLNM <- lvm(test,lambda = ega_factors, omega_zeta = matrixConfirm)
