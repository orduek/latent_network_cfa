...
# for time - I remove these for now - will put stability back in the last version
...
### A.3 bootversion
```{r eval = TRUE, results = 'hide', echo=FALSE}
bootEGA_pcl <- bootEGA(df2, 500, type = "resampling", ncores = 5,  plot.typicalStructure = FALSE )
```
plot bootversion
```{r}
...
CURRENTLY NOT CORRET, BECAUSE WE HAVEN'T SEEN THE DATA YET
```{r}
